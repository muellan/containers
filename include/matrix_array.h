...
class matrix_array
{
    ...
    public:
        ...
        stride_iter_t_
        operator + (difference_type i) const noexcept {
            return stride_iter_t_{p_ + (stride * i)};
        }
        //-----------------------------------------------------
        stride_iter_t_&
        operator -- () noexcept {
...
public:
    ...
    constexpr inline friend size_type
    size(const matrix_array& m) noexcept {
        return m.size();
    }
    //-----------------------------------------------------
    ...
    empty(const matrix_array& m) noexcept {
        return m.empty();
    }
    //-----------------------------------------------------
    static constexpr size_type
    ...
    begin(matrix_array& i) noexcept {
        return i.begin();
    }
    inline friend const_iterator
    begin(const matrix_array& i) noexcept {
        return i.begin();
    }
    inline friend const_iterator
    cbegin(const matrix_array& i) noexcept {
        return i.cbegin();
    }
    //-----------------------------------------------------
    iterator
    ...
    //-----------------------------------------------------
    inline friend iterator
    end(matrix_array& i) noexcept {
        return i.end();
    }
    inline friend const_iterator
    end(const matrix_array& i) noexcept {
        return i.end();
    }
    inline friend const_iterator
    cend(const matrix_array& i) noexcept {
        return i.cend();
    }
    ...
    rbegin(matrix_array& i) noexcept {
        return i.rbegin();
    }
    inline friend const_reverse_iterator
    rbegin(const matrix_array& i) noexcept {
        return i.rbegin();
    }
    inline friend const_reverse_iterator
    crbegin(const matrix_array& i) noexcept {
        return i.crbegin();
    }
    ...
    //-----------------------------------------------------
    inline friend reverse_iterator
    rend(matrix_array& i) noexcept {
        return i.rend();
    }
    inline friend const_reverse_iterator
    rend(const matrix_array& i) noexcept {
        return i.rend();
    }
    inline friend const_reverse_iterator
    crend(const matrix_array& i) noexcept {
        return i.crend();
    }
    ...
    //---------------------------------------------------------------
    row_iterator
    begin_row(size_type index) noexcept {
        return row_iterator{std::addressof(m_[index][0])};
    }
    //-----------------------------------------------------
    const_row_iterator
    begin_row(size_type index) const noexcept {
        return const_row_iterator{std::addressof(m_[index][0])};
    }
    //-----------------------------------------------------
    const_row_iterator
    cbegin_row(size_type index) const noexcept {
        return const_row_iterator{std::addressof(m_[index][0])};
    }
    ...
    //-----------------------------------------------------
    col_iterator
    end_col(size_type index) noexcept {
        return col_iterator{std::addressof(m_[nrows][index])};
    }
    //-----------------------------------------------------
    const_col_iterator
    end_col(size_type index) const noexcept {
        return const_col_iterator{std::addressof(m_[nrows][index])};
    }
    //-----------------------------------------------------
    const_col_iterator
    cend_col(size_type index) const noexcept {
        return const_col_iterator{std::addressof(m_[nrows][index])};
    }
