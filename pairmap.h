...
class pairmap
{
    ...
    using storage_t_ = matrix<ValueType,maxIndex,maxIndex+1>;
    ...
    public:
        ...
        //-----------------------------------------------------
        explicit constexpr
        iter_t_(Iter start, difference_type offset):
    ...
    public:
        ...
        //-----------------------------------------------------
        explicit constexpr
        index_iter_t_(Iter start, difference_type index):
    ...
    struct section_t_
    {
        ...
        //-----------------------------------------------------
        explicit constexpr
        section_t_(Iter beg, difference_type fidx, difference_type lidx):
