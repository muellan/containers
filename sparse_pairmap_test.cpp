...
//    std::cout << "max index " << pm1.max_index() << std::endl;
//
//    for(size_t i = 0; i <= pm1.max_index(); ++i) {
//        for(size_t j = i+1; j <= pm1.max_index(); ++j) {
//            auto it = pm1.find(i,j);
//            if(it != pm1.end())
//                std::cout << "(" << i << "," << j << ") -> " << *it << std::endl;
//        }
//    }
//
//    pm1.pull_index_range(0,0);
//
//    std::cout << "--------------------------\n";
//    for(size_t i = 0; i <= pm1.max_index(); ++i) {
//        for(size_t j = i+1; j <= pm1.max_index(); ++j) {
